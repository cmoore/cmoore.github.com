...
The idea is this: If I can't get people to understand what exactly monads are, whether they are unable or unwilling, it doesn't mean that they can't benefit from Haskell's other awesome features and performance.  I wrote Haskell daily and didn't need to write a monad until almost 8 months in, and even that I later understood was unnecessary.  Monads are great and they let you do very powerful things.  That said, I do think they are a little overused among Haskell developers.  I belive that web development is, at its core, a very simple thing and I don't think I need a monad to represent it.  Time will tell though, as I'm not opposed to being proved wrong.
